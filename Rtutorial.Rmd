...
Here is some generic code for exploring a data set named DataFile. You can change DataFile to Neuron_Recording_Data in the code below to explore the data from the csv file.
