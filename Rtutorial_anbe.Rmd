...
library(UsingR)
# simple.eda function doesn't seem that great with this dataset
# simple.eda(DataFile)
```
...
If you want to calculate the play rate.
!!! How do you compare the play rate for each? It's a single number or data point. Not enough power for a t test.

```{r}
# Play rate
# Total time Nova played
NovaPlayTotal <- sum(NovaPlay$Duration)
# Total time for all focal observations
Total <- sum(ResearchObs$FocalDuration.s.)
# Play rate for Nova by dividing how long he played in every focal and total focal time
NovaPlayRate <- NovaPlayTotal/Total
# Print play rate
NovaPlayRate


NewtonPlayTotal <- sum(NewtonPlay$Duration)
# Play rate for Nova by dividing how long he played in every focal and total focal time
NewtonPlayRate <- NewtonPlayTotal/Total
# Print play rate
NewtonPlayRate
```
